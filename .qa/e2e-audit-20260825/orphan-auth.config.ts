...
export default defineConfig({
  ...
  globalSetup: '/home/user/Atelier/.qa/e2e-audit-20260825/auth-setup.ts',
  reporter: [['list'], ['json', { outputFile: '/home/user/Atelier/.qa/e2e-audit-20260825/results-auth.json' }]],
  use: {
    baseURL: BASE_URL,
    locale: 'ja-JP',
    timezoneId: 'Asia/Tokyo',
    colorScheme: 'light',
    storageState: '/home/user/Atelier/.qa/e2e-audit-20260825/storage-state.json',
