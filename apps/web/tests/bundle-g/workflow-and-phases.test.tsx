...
import { PhaseList, type PhaseRow } from '../../app/workflow/s_f02/_components/PhaseList';
...
describe('PhaseList (T-UC-11)', () => {
  ...
  it('updates status via select', () => {
    ...
    expect((screen.getByLabelText('設計 の状態') as HTMLSelectElement).value).toBe('in_progress');
  });
});
