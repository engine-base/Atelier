/**
 * WorkspacePicker — T-US-02 (TopBar 中央用)
 *
 * 現在の workspace を表示し、別 WS への切替 dropdown を出す。
 * data は親から prop で受ける (controlled): 親が TanStack Query (T-US-05) で
 * `/workspaces` から取得し、選択は localStorage または URL クエリで保持する想定。
 */
...
export function WorkspacePicker({ value, options, onChange, className }: WorkspacePickerProps) {
