...
USER_MESSAGES: dict[str, str] = {
    ...
    "consent_version_stale": (
        "表示中の規約が最新ではない可能性があります。"
        "画面を再読み込みして、最新の内容をご確認のうえもう一度お進みください。"
    ),
    ...
    # GAP-269: 退会 (30 日猶予) 中のアカウントで正しいパスワードを入れた場合。
    # 「パスワードが違う」と返すと復元の導線にたどり着けない。
    "account_deleting": (
        "このアカウントは退会手続き中です。サインイン画面の"
        "「退会済みアカウントの復元」から 30 日以内であれば復元できます。"
    ),
    # ---- 退会・復活 ------------------------------------------------------ #
