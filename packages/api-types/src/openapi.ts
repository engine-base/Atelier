...
export interface paths {
    ...
    "/auth/signout": {
        ...
        put?: never;
        /**
         * サインアウト (この人の refresh token を全部失効させる)
         * @description 画面側は cookie と localStorage を捨てるが、盗まれた refresh token は それでは生き続けるため、サーバー側でも失効させる。
         *
         */
        post: {
            parameters: {
    ...
    "/billing/portal": {
        ...
        get?: never;
        put?: never;
        /** Stripe カスタマーポータル (解約・支払方法変更・領収書) の URL を発行 */
        post: {
            parameters: {
                query?: never;
                header?: never;
            ...
            responses: {
                /** @description ポータル URL (遷移先で解約・支払方法変更ができる) */
                200: {
                    headers: {
                        [name: string]: unknown;
                    };
                ...
                /** @description 有料プランの契約が無い (解約するものが無い) */
                409: {
                    headers: {
                        [name: string]: unknown;
                    };
    ...
    "/projects/{project_id}/flow": {
        ...
        get: {
            ...
            requestBody?: never;
            responses: {
                /** @description seq 昇順のステージ一覧 (current=現在のステージ / 担当社員・既存スレッド解決済み) */
                200: {
                    headers: {
                        [name: string]: unknown;
                    };
                    content: {
                        "application/json": {
                            data?: components["schemas"]["FlowStage"][];
                        };
                    };
                };
                /** @description 未認証 */
    ...
    "/projects/{project_id}/flow/{stage_key}/complete": {
        ...
        get?: never;
        put?: never;
        /** ステージ完了（GAP-150 — hard_gate は confirm=true 必須） */
        post: {
            parameters: {
                query?: never;
                header?: never;
            ...
            responses: {
                /** @description 完了後のフロー全体 (current の移動 = 次ステージへの引き継ぎ) */
                200: {
                    headers: {
                        [name: string]: unknown;
                    };
    ...
    "/projects/{project_id}/flow/{stage_key}/skip": {
        ...
        get?: never;
        put?: never;
        /** ステージスキップ（GAP-150 — skippable のみ・理由必須） */
        post: {
            parameters: {
                query?: never;
                header?: never;
            ...
            responses: {
                ...
                /** @description skippable でない or 完了済み */
                409: {
                    headers: {
                        [name: string]: unknown;
                    };
    ...
    "/projects/{project_id}/flow/{stage_key}/reopen": {
        ...
        get?: never;
        put?: never;
        /** ステージ差し戻し（GAP-150 — done/skipped → pending） */
        post: {
            parameters: {
                query?: never;
                header?: never;
    ...
    "/projects/{project_id}/flow/{stage_key}/thread": {
        ...
        get?: never;
        put?: never;
        /** 工程専用スレッドの取得/作成（GAP-151 — 工程 = 会話の入れ物・担当は工程×部門で固定） */
        post: {
            parameters: {
                query?: never;
                header?: never;
            ...
            requestBody?: never;
            responses: {
                /** @description 工程に固定されたスレッド (無ければ作成、担当社員の未割当スレッドがあれば採用) */
                200: {
                    headers: {
                        [name: string]: unknown;
                    };
    ...
    "/projects/{project_id}/design-note": {
        ...
        /** デザインノート取得（GAP-143 — Open Design の DESIGN.md 相当） */
        get: {
            parameters: {
                query?: never;
                header?: never;
            ...
            requestBody?: never;
            responses: {
                /** @description プロジェクトのデザインノート (ワンダの全生成・改訂に自動注入) */
                200: {
                    headers: {
                        [name: string]: unknown;
                    };
...
export interface components {
    schemas: {
        ...
        FlowStage: {
            ...
            skippable: boolean;
            /** @description 致命工程 — 完了に confirm=true 必須・スキップ不可 */
            hard_gate: boolean;
